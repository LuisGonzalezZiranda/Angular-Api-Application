// To parse this data:
//
//   import { Convert, Peliculas } from "./file";
//
//   const peliculas = Convert.toPeliculas(json);
//
...
export class Convert {
    public static toPeliculas(json: string): Peliculas {
        return cast(JSON.parse(json), r("Peliculas"));
    }

    public static peliculasToJson(value: Peliculas): string {
        return JSON.stringify(uncast(value, r("Peliculas")), null, 2);
    }
}
